...
/**
 * Created by freshfuturesmy on 28/09/17.
 */

public class BadgeArrowDrawerDrawable extends DrawerArrowDrawable {
    ...
    public BadgeArrowDrawerDrawable(Context context) {
        super(context);

        backgroundPaint = new Paint();
        backgroundPaint.setColor(context.getResources().getColor(R.color.custom_email_red));
